...
export const basicProjects = [
	{
		...
		githubLink: "https://github.com/zohrehroshandel/html-css-practice",
	},
	{
        ...
        githubLink:'https://github.com/zohrehroshandel/flowershop-exampel-project'
	},
	{
      ...
      githubLink:'https://github.com/zohrehroshandel/quiez-app'
	},
	{
		titleKey: "projects.starbucks_title",
		descKey: "projects.starbucks_desc",
		images: [`${path}/starbox.png`, `${path}/starbox1.png`],
    githubLink:'https://github.com/zohrehroshandel/starbox'
	},
];

export const hanbokImages = Array.from(
	{ length: 16 },
	(_, i) => `${path}/hanbok${i + 1}.png`,
);
